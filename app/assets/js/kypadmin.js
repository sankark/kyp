var app = angular.module('KypAdmin', ['ngRoute', 'ngResource', 'textAngular', 'ngTextcomplete', 'autocomplete', 'translit', 'profile']);
...
function ProfileController($rootScope, $scope, $location, profile, translit, $routeParams) {
